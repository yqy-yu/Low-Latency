...
uplevel #0 { report_timing -path full -delay max -nworst 40 -max_paths 40 -significant_digits 2 -sort_by group > 0_55nm_minarea_timing_lp.txt}

uplevel #0 { report_area -hierarchy > 0_55nm_minarea_area_lp.txt}
