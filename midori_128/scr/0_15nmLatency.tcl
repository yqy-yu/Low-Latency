...
set libname "NanGate_15nm_OCL_typical_conditional_ccs.db"
...
uplevel #0 { report_timing -path full -delay max -nworst 40 -max_paths 40 -significant_digits 2 -sort_by group > 0_15nm_minlatency_timing_lp.txt}

uplevel #0 { report_area -hierarchy > 0_15nm_minlatency_area_lp.txt}
