...
uplevel #0 { report_timing -path full -delay max -nworst 40 -max_paths 40 -significant_digits 2 -sort_by group > 0_28nm_minlatency_timing_lp.txt}

uplevel #0 { report_area -hierarchy > 0_28nm_minlatency_area_lp.txt}
